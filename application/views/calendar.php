...
<link rel="stylesheet" href ="<?php echo base_url()?>assets/css/jquery-frontier-cal-1.3.2.css" />
...
<link rel="stylesheet" href="<?php echo base_url()?>assets/css/jquery-ui-1.8.1.custom.css" />
<!--
...
-->
<script type="text/javascript" src="<?php echo base_url()?>assets/js/jquery-1.4.2-ie-fix.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/js/jquery.qtip-1.0.js"></script>
<!--
	(Required for plugin)
	Dependancies for JQuery Frontier Calendar plugin.
    ** THESE MUST BE INCLUDED BEFORE THE FRONTIER CALENDAR PLUGIN. **
-->
<script type="text/javascript" src="<?php echo base_url()?>assets/js/jshashtable-2.1.js"></script>
<!-- Include JQuery Frontier Calendar plugin -->
<script type="text/javascript" src="<?php echo base_url()?>assets/js/jquery-frontier-cal-1.3.2.min.js"></script>
...
<h1 style="font-size: 30px; font-weight: bold; margin-top:7%; margin-left:20%; text-align: center;">Calendar</h1>
	

		<div id="example" style="width:70%; margin-left:25%; margin-top:-2%;">
